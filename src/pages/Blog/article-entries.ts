...
export const BLOG_ENTRIES: BlogEntry[] = [
  ...
  },
  {
    ...
    images: [
      ...
      { src: "./scrum-manager.jpg", alt: "Scrum managers figure" },
    ],
    content: [
