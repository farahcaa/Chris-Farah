  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row justify-center">
        <div className="bg-Bs flex items-center flex-col rounded-full h-full xl:w-1/4 xs:w-full md:w-5/12 lg:w-5/12 xs:mx-0 md:mr-1 lg:mx-10 shadow-2xl ">
          <h1 className="text-5xl mt-20  ">Student</h1>
          <p className="text-2xl mx-4 xl:mx-20 mt-10 text-center">
        ...
        <div className="bg-Asb flex items-center flex-col rounded-full h-full xs:w-full md:w-5/12 lg:w-5/12 xl:w-1/4 xs:mx-0 md:ml-1 lg:mx-10 xs:mt-10 md:mt-52 shadow-2xl ">
          <h1 className="text-5xl mt-20  ">Developer</h1>
          <p className="text-2xl xs:mx-4 xl:mx-20 mt-10 text-center">
