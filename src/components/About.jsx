  ...
  return (
    ...
    >
      ...
      <div
        className={`${
          dropdiv1
            ? "bg-Asb z-0 overflow-hidden rounded-[5rem] flex flex-col  shadow-lg transform xl:h-[50rem] lg:h-[65rem] md:h-[80rem] sm:h-[80rem] xs:h-[90rem] duration-1000"
            : "bg-Asb z-0 overflow-hidden rounded-[5rem] flex flex-col p-4 mb-5 shadow-lg transform h-[9rem] duration-1000"
        }`}
